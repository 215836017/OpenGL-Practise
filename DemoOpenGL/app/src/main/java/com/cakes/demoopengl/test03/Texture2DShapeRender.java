...
/**
 * OpenGL中的哪里可以用来表示图像。照片甚至由一个数学算法生成的分型数据。
 * <p>
 * 1. 创建纹理的第一步
 ...
 */
public class Texture2DShapeRender implements GLSurfaceView.Renderer {
    /**
     * 更新shader的位置
     */
    private static final String VERTEX_SHADER_FILE = "test03/texture_vertex_shader.glsl";
    private static final String FRAGMENT_SHADER_FILE = "test03/texture_fragment_shader.glsl";
...
//        mTextureId = createTexture2();
    ...
    private int createTexture() {
        ...
        //加载Bitmap
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.a2, options);
        //保存到textureObjectId
